  ...
  return (
    <div className="d-block">
      <Form onSubmit={event => redirectSearch(event)}>
        <InputGroup>
          <Form.Control placeholder="Search Giphy..." defaultValue={q} ref={ref => (searchRef = ref)} type="text" />
          <InputGroup.Append>
      ...
      <Navbar expand="sm" variant="dark">
        ...
        <Navbar.Collapse className="pt-2 pt-sm-0">
          ...
          <Nav className="justify-content-end flex-sm-grow-1">
            <Nav.Item as={Link} to="/" className="px-sm-2">
              Trending
            </Nav.Item>
            <Nav.Item as={Link} to="/favorites" className="px-sm-2">
              Favorites
            </Nav.Item>
            <Nav.Item className="px-sm-2 signout" onClick={logout}>
